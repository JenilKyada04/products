    ...
    return (
        <div className="mx-auto max-w-360 ">
            ...
            <div className="mt-10 flex flex-wrap gap-10 items-center justify-center mb-40 ">
                {review.map((item) => (
                    <div key={item.id} className="w-96 bg-white rounded-3xl p-5    gap-2 px-10 flex flex-col border-gray-200 border-2">
                        ...
                        <p className="max-w-md mx-auto  mt-4">"{item.desc}"</p>
                    </div>
                ))}
            </div>
        </div>
