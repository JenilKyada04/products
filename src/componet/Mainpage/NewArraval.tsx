...
function NewArraval() {
  return (
    <div className='max-w-310 mx-auto' id='newarrivals'>
      <h1 className="font-integral mt-20 inter text-[48px] tracking-normal flex items-center justify-center text-center "
      >NEW ARRIVALS</h1>
      <div>
